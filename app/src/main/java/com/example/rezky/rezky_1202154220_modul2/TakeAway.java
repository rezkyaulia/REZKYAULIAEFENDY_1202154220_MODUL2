...
public class TakeAway extends AppCompatActivity {
    ...
    private TextInputLayout name,Handphone,Alamat,catat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = (TextInputLayout) findViewById(R.id.nama);
        Handphone = (TextInputLayout) findViewById(R.id.phone);
        Alamat = (TextInputLayout) findViewById(R.id.alamat);
        catat = (TextInputLayout) findViewById(R.id.catatan);

        //men-setting toolbar yang akan muncul di atas dengan nama Take Away
    ...
    public void pilihpesan(View view) {
       ...
       String telfon = Handphone.getEditText().getText().toString();
       String alamat = Alamat.getEditText().getText().toString();
       String catatan = catat.getEditText().getText().toString();

        if (nama.isEmpty()|| telfon.isEmpty() || alamat.isEmpty() || catatan.isEmpty()){
    ...
    public void processDatePickerResult(int year, int month, int day) {
        ...
        String nama = name.getEditText().getText().toString();
        String telepon = Handphone.getEditText().getText().toString();
